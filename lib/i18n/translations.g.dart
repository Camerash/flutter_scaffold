...
class _TranslationsZhCn extends _TranslationsEn {
  ...
  @override
  late final _TranslationsErrorZhCn error = _TranslationsErrorZhCn._(_root);
  @override
  late final _TranslationsLoginZhCn login = _TranslationsLoginZhCn._(_root);
  @override
  late final _TranslationsAccountZhCn account =
      _TranslationsAccountZhCn._(_root);
}

// Path: common
class _TranslationsCommonZhCn extends _TranslationsCommonEn {
  _TranslationsCommonZhCn._(_TranslationsZhCn root)
      : this._root = root,
        super._(root);
...
class _TranslationsErrorZhCn extends _TranslationsErrorEn {
  _TranslationsErrorZhCn._(_TranslationsZhCn root)
      : this._root = root,
        super._(root);
  ...
  // Translations
  @override
  String get common => '发生错误，请重试';
  @override
  String fieldEmpty({required Object field}) => '$field 不能为空';
  @override
  String get emailFormat => '电子邮件格式不正确';
  @override
  String get passwordLength => '密码必须至少6个字符长';
  @override
  String get login => '电子邮件或密码不正确';
  @override
  String get emailInUse => '电子邮件已经在使用';
  @override
  String get passwordTooWeak => '密码太弱了';
  @override
  String get signup => '注册错误';
}

// Path: login
class _TranslationsLoginZhCn extends _TranslationsLoginEn {
  _TranslationsLoginZhCn._(_TranslationsZhCn root)
      : this._root = root,
        super._(root);
  ...
  @override
  String get forgotPassword => '忘记了密码';
  @override
  String get noAccount => '没有帐户？';
  @override
  String get createANewAccount => '创建一个新帐户';
}

// Path: account
class _TranslationsAccountZhCn extends _TranslationsAccountEn {
  _TranslationsAccountZhCn._(_TranslationsZhCn root)
      : this._root = root,
        super._(root);
...
class _TranslationsZhHk extends _TranslationsEn {
  ...
  @override
  late final _TranslationsZhHk _root = this; // ignore: unused_field

  // Translations
  @override
  late final _TranslationsCommonZhHk common = _TranslationsCommonZhHk._(_root);
  @override
  late final _TranslationsErrorZhHk error = _TranslationsErrorZhHk._(_root);
  @override
  late final _TranslationsLoginZhHk login = _TranslationsLoginZhHk._(_root);
  @override
  late final _TranslationsAccountZhHk account =
      _TranslationsAccountZhHk._(_root);
}

// Path: common
class _TranslationsCommonZhHk extends _TranslationsCommonEn {
  _TranslationsCommonZhHk._(_TranslationsZhHk root)
      : this._root = root,
        super._(root);

  @override
  final _TranslationsZhHk _root; // ignore: unused_field
...
class _TranslationsErrorZhHk extends _TranslationsErrorEn {
  _TranslationsErrorZhHk._(_TranslationsZhHk root)
      : this._root = root,
        super._(root);
  ...
  // Translations
  @override
  String get common => '發生錯誤，請重試';
  @override
  String fieldEmpty({required Object field}) => '$field 不能為空';
  @override
  String get emailFormat => '電子郵件格式不正確';
  @override
  String get passwordLength => '密碼必須至少6個字符長';
  @override
  String get login => '電子郵件或密碼不正確';
  @override
  String get emailInUse => '電子郵件已經在使用';
  @override
  String get passwordTooWeak => '密碼太弱了';
  @override
  String get signup => '註冊錯誤';
}

// Path: login
class _TranslationsLoginZhHk extends _TranslationsLoginEn {
  _TranslationsLoginZhHk._(_TranslationsZhHk root)
      : this._root = root,
        super._(root);
  ...
  @override
  String get forgotPassword => '忘記了密碼';
  @override
  String get noAccount => '沒有帳戶？';
  @override
  String get createANewAccount => '創建一個新帳戶';
}

// Path: account
class _TranslationsAccountZhHk extends _TranslationsAccountEn {
  _TranslationsAccountZhHk._(_TranslationsZhHk root)
      : this._root = root,
        super._(root);
...
extension on _TranslationsEn {
  Map<String, dynamic> _buildFlatMap() {
    return <String, dynamic>{
      ...
      'error.fieldEmpty': ({required Object field}) =>
